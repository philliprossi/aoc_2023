...
def created_adjusted_grid(grid, expansion_factor_row, expansion_factor_col, expansion_multiple = 1) :
    adjusted_grid = {}
    for key, value in grid.items():
...
adjusted_grid_p2 = created_adjusted_grid(grid, expansion_factor_row, expansion_factor_col, expansion_multiple = (1000000 - 1))
